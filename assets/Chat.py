...
class Ui_PartisanMain(object):
    def setupUi(self, PartisanMain):
        ...
        self.gridContacts.addWidget(self.line, 1, 0, 1, 2)
        ...
        self.gridChat.addWidget(self.label, 0, 0, 1, 2)
        ...
        self.gridChat.addWidget(self.lineInputMessage, 4, 0, 1, 1)
        ...
        self.gridChat.addWidget(self.pushButtonSendMessage, 4, 1, 1, 1)
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridChat.addWidget(self.line_2, 1, 0, 1, 2)
    ...
    def retranslateUi(self, PartisanMain):
        ...
        self.label.setText(_translate("PartisanMain", "Chat"))
